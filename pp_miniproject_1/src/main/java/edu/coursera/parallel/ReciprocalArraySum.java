 ...
 */
// For Mini-project 1, it's usually best to choose a threshold so that the
// number of tasks
// equals the number of processor cores on your machine. (If it equals the
// number of hardware
// threads, that's okay too.) However, this may not be the best approach for
// other applications
// where there may be more variation in execution times across tasks, compared
// to Mini-project
// 1.
public final class ReciprocalArraySum {
	...
	protected static double parArraySum(final double[] input) {
		...
		// sum += 1 / input[i];
		// }
		// ReciprocalArraySumTask task1 = new ReciprocalArraySumTask( 0,
	...
	private static class TaskStarter extends RecursiveAction {
